...
st.set_page_config(page_title="MemoryDesk", page_icon="🎧", layout="wide")

# --- Sidebar ---
st.sidebar.title("🎧 MemoryDesk")
st.sidebar.markdown("**AI Support Agent with Long-Term Memory**")
st.sidebar.caption("Powered by PostgreSQL + pgvector + Gemini")
st.sidebar.divider()
...
st.caption("Persistent agentic memory using vector search")
...
if "loaded" not in st.session_state or st.session_state.get("loaded_customer") != customer_id:
